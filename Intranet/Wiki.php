...
<head>
    ...
    <style>
        ...
        h3 {
            color: #28a745; /* Change to your preferred color for subsection titles */
        }
    </style>
</head>
<body>
    <div class="container mt-5">
        ...
        <div class="content-section">
            ...
            <h3>Accueil</h3>
            <p>Bienvenue sur notre site de fast food! Nous sommes ravis de vous accueillir dans notre univers où rapidité, qualité et convivialité se rencontrent. Sur notre page d'accueil, vous trouverez une présentation complète de notre entreprise, de nos valeurs, et de notre engagement envers nos clients.</p>
            <p>Notre mission est de vous offrir des repas délicieux, préparés rapidement et avec des ingrédients de qualité. Que vous soyez en quête d'un déjeuner rapide, d'un dîner en famille ou d'une collation en soirée, nous avons ce qu'il vous faut. Explorez notre menu varié et découvrez nos spécialités qui sauront satisfaire toutes les envies.</p>
            <p>La page d'accueil vous permet également de rester informé sur nos dernières promotions, événements et nouveautés. N'hésitez pas à nous contacter pour toute question ou pour en savoir plus sur nos services.</p>
